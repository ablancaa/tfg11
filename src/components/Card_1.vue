...
<svg xml:space="preserve" viewBox="0 0 100 100" height="100px" width="100px" y="0px" x="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" class="glasses">  <image href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAYAAABw4pVUAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
wWsAAAAASUVORK5CYII=" y="0" x="0" height="100" width="100" id="image0"></image>
</svg>
    </div>
</template>
...
.card:hover .heading {
  transform: translateY(6em) translateX(2.3em);
}
